...
static void refresh_btn_cb(lv_event_t *e)
{
    ...
    lv_obj_set_size(file_list, 300, 120);
...
{
    print_screen = lv_obj_create(lv_scr_act());
    ...
    lv_obj_set_size(refresh_btn, 80, 24);
    ...
    lv_obj_set_size(ctrl_row, 300, 28);
    ...
    lv_obj_set_size(pause_btn, 92, 24);
    ...
    lv_obj_set_size(resume_btn, 92, 24);
    ...
    lv_obj_set_size(cancel_btn, 92, 24);
