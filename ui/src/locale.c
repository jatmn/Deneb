...
static const struct { const char *key; const char *val; } en_defaults[] = {
    ...
    {"network.connect_wifi", "Connect Wi-Fi"},
    {"network.disconnect_wifi", "Disconnect Wi-Fi"},
    {"network.connect_starting", "Wi-Fi setup portal starting"},
    {"network.disconnect_requested", "Wi-Fi disconnect requested"},
