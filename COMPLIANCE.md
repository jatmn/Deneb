...
Deneb should be an addon/mod kit built around user-supplied firmware or a user-owned printer. Release artifacts should contain only Deneb-owned files, metadata, manifests, signatures, and scripts needed to install or remove Deneb changes.
