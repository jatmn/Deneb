...
- Desktop Cura discovery, upload/start, monitor, and pending-job behavior.
  ...
  completion, pause/resume, and cancel/abort back to idle are covered by the
  2026-06-14 supervised Cura 5.13 local-network run on package `ff49e86b`;
  stale-state recovery and progress/time reporting remain open.
