...
| Digital Factory | <img src="touchscreen-screens/digital-factory.png" width="160" alt="Digital Factory screen"> | Digital Factory connection controls. | Show pairing PIN, connection status, and authenticated disconnect. | Needs current cloud/offline state language kept explicit so local-first behavior remains obvious. |
