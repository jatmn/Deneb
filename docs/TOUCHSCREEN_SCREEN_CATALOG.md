...
wsl -- bash -lc "cd /mnt/c/temp/Deneb && rm -rf /tmp/deneb-screen-ppm && ui/build-wsl-host/deneb-ui --lang en --screenshot-dir /tmp/deneb-screen-ppm"
```
...
| Digital Factory | <img src="touchscreen-screens/digital-factory.png" width="160" alt="Digital Factory screen"> | Digital Factory service controls. | Show pairing PIN, disconnect pairing, and restart the Digital Factory service. | Needs current cloud/offline state language kept explicit so local-first behavior remains obvious. |
...
- Digital Factory paired, unpaired, and service-error states.
