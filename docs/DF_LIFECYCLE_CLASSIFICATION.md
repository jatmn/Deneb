...
The remaining on-target measurements (remote print-job action) should be
collected via
...
- Validate on target in remote print-job action states before marking Digital
  ...
  wait-user-action plus Cancel and Continue are now covered by 2026-06-13
  hardware evidence.
