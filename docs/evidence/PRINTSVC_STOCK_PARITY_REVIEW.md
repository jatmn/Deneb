...
- Native print prepare deliberately skips the stock-derived normal-print
  ...
  sequence, and a 2026-06-13 supervised target run on package `6cd72899`
  confirmed startup no longer does the double Z home and still starts as
  expected.
