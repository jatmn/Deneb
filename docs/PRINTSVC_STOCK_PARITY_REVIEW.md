...
- Representative Cura/slicer geometry for completion, pause/resume, and abort,
  including the touchscreen Stop park/home behavior after the stock-derived
  abort policy is deployed, and Resume reheating after Pause cooldown.
