...
- [x] Stock `connector.py` Digital Factory cloud connector has a Deneb-owned C
  ...
  Cancel. Continue/start after prompt is also covered. Print-job actions remain
  open before calling this fully proven.
